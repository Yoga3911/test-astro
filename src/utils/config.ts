...
export const NAV_ITEMS: NavItem[] = [
  { label: 'Home', href: '/' },
  {
    label: 'About Us',
    href: '/about-us',
    description: 'Mengenalkan sejarah, visi misi, tata tertib, dan profil lulusan',
    children: [
      { label: 'Sejarah SDK Maria Fatima', href: '/about-us#sejarah', description: 'Perjalanan dedikasi pendidikan sejak masa awal' },
      { label: 'Visi & Misi', href: '/about-us#visi-misi', description: 'Arah dan komitmen pelayanan pendidikan' },
      { label: 'Core Value', href: '/about-us#core-values', description: 'Nilai-nilai luhur penuntun langkah' },
      { label: '8 Profil Lulusan', href: '/about-us#profil-lulusan', description: 'Kompetensi holistik murid SDK Maria Fatima' },
      { label: 'Tata Tertib', href: '/about-us#tata-tertib', description: 'Panduan kedisiplinan dan budaya sekolah' },
    ],
  },
  {
    label: 'Heritage',
  ...
  },
  {
    label: 'People',
    href: '/people',
    description: 'Profil SDM Pendidik dan Tenaga Kependidikan',
    children: [
      { label: 'Kepala Sekolah', href: '/people#kepala-sekolah', description: 'Pimpinan & arah strategis sekolah' },
      { label: 'Guru', href: '/people#guru', description: 'Pendidik berdedikasi & profesional' },
      { label: 'Karyawan', href: '/people#karyawan', description: 'Staf pendukung layanan prima' },
    ],
  },
  {
    label: 'News & Events',
    href: '/news-events',
    description: 'Branding aktif dan warta kegiatan sekolah',
    children: [
      { label: 'Artikel', href: '/news-events?kategori=Artikel', description: 'Tulisan edukatif guru dan siswa' },
      { label: 'Berita', href: '/news-events?kategori=Berita', description: 'Warta terkini dan liputan acara sekolah' },
      { label: 'Galeri Kegiatan', href: '/news-events#galeri', description: 'Dokumentasi momen berharga' },
    ],
  },
  {
    label: 'Media',
    href: '/media',
    description: 'Mars, Jingle, Galeri Foto & Video',
    children: [
      { label: 'Mars SDK', href: '/media#mars-sdk', description: 'Lagu kebanggaan SDK Maria Fatima' },
      { label: 'Jingle UKB', href: '/media#jingle-ukb', description: 'Jingle Unit Kegiatan Belajar' },
      { label: 'Galeri Foto', href: '/media#galeri-foto', description: 'Koleksi dokumentasi foto sekolah' },
      { label: 'Video', href: '/media#video', description: 'Video profil & video dokumentasi' },
    ],
  },
  {
    label: 'Classroom',
    href: '/classroom',
    description: 'Aktivitas KBM Kelas 1 sampai 6',
  },
  {
    label: 'Admission',
    href: '/admission',
    description: 'Penerimaan Peserta Didik Baru (PPDB Online)',
  },
];
